...
def index_logs(file, host, port, progress):
...
if __name__ == "__main__":
	...
	parser.add_argument('--progress', metavar='N', type=int, default=4096, help='print progress every N logs')
	args = parser.parse_args()

	index_logs(args.file, args.host, args.port, args.progress)
